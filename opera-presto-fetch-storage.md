...
permalink: /ru/storage/
lang: ru
---

<nav id="top" aria-label="Верхняя навигация">
  <a href="{{ '/ru/dragonfly-shadow-dom/' | relative_url }}" rel="prev">← Назад: Opera Dragonfly и Shadow DOM</a> · НЕДЕЛЯ: <a href="{{ '/ru/' | relative_url }}" title="Движок, который мы потеряли">I</a>—<a href="{{ '/ru/revival/' | relative_url }}" title="Движок, который мы оживляем">II</a>—<a href="{{ '/ru/modern/' | relative_url }}" title="Движок, который чему-то учится">III</a>—<a href="{{ '/ru/css/' | relative_url }}" title="Движок, которому нужен CSS">IV</a>—<a href="{{ '/ru/es2015-gstreamer/' | relative_url }}" title="Движок, который обогнал Chrome">V</a>—<a href="{{ '/ru/dragonfly-shadow-dom/' | relative_url }}" title="Opera Dragonfly и Shadow DOM">VI</a>—<strong>VII</strong> · <a href="{{ '/storage/' | relative_url }}" lang="en">English</a> · <strong>Русский</strong>
</nav>
...
7. **Собственное решение**, например поверх того же Search engine. Технически возможно, и было бы интересно, не будь у нас очереди из десятка других подсистем, требующих написания. К тому же явно не соответствует идеологии Opera писать свои решения только при отсутствии подходящих решений.
...
Также я решил сделать проект немного более публичным и завёл для него [канал в Telegram](https://t.me/opera_revival). Я планирую там делать анонсы, рассказывать какие-то небольшие, но интересные вещи (далеко не всё попадает в эти статьи) и публиковать билды. Если вам интересен проект — присоединяйтесь.

<nav aria-label="Нижняя навигация">
  <a href="#top">↑ Наверх</a> · НЕДЕЛЯ: <a href="{{ '/ru/' | relative_url }}" title="Движок, который мы потеряли">I</a>—<a href="{{ '/ru/revival/' | relative_url }}" title="Движок, который мы оживляем">II</a>—<a href="{{ '/ru/modern/' | relative_url }}" title="Движок, который чему-то учится">III</a>—<a href="{{ '/ru/css/' | relative_url }}" title="Движок, которому нужен CSS">IV</a>—<a href="{{ '/ru/es2015-gstreamer/' | relative_url }}" title="Движок, который обогнал Chrome">V</a>—<a href="{{ '/ru/dragonfly-shadow-dom/' | relative_url }}" title="Opera Dragonfly и Shadow DOM">VI</a>—<strong>VII</strong> · <a href="{{ '/storage/' | relative_url }}" lang="en">English</a> · <strong>Русский</strong>
</nav>
