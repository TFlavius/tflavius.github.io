...
<nav aria-label="Bottom navigation" style="display: flex; flex-wrap: wrap; gap: 0.35em 0.75em;">
  <span><a href="#top">↑ Back to top</a> · <a href="{{ '/modern/' | relative_url }}" rel="next">Next: The Engine That Learns →</a> · WEEK: <a href="{{ '/' | relative_url }}" title="The Engine We Lost">I</a>—<strong>II</strong>—<a href="{{ '/modern/' | relative_url }}" title="The Engine That Learns">III</a>—<a href="{{ '/css/' | relative_url }}" title="The Engine That Needs CSS">IV</a>—<a href="{{ '/es2015-gstreamer/' | relative_url }}" title="The Engine That Outpaced Chrome">V</a>—<a href="{{ '/dragonfly-shadow-dom/' | relative_url }}" title="Opera Dragonfly and Shadow DOM">VI</a>—<a href="{{ '/fetch-storage/' | relative_url }}" title="The Engine That Can Google Again">VII</a>—<a href="{{ '/indexeddb-hwaccel/' | relative_url }}" title="The New IndexedDB and the Old VEGA">VIII</a>—<a href="{{ '/pseudothread/' | relative_url }}" title="A Tangled Tale of Several Stacks">IX</a></span>
</nav>
