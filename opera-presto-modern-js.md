...
<nav aria-label="Нижняя навигация">
  <a href="#top">↑ Наверх</a> · <a href="{{ '/ru/css/' | relative_url }}" rel="next">Дальше: Движок, которому нужен CSS →</a> · НЕДЕЛЯ: <a href="{{ '/ru/' | relative_url }}" title="Движок, который мы потеряли">I</a>—<a href="{{ '/ru/revival/' | relative_url }}" title="Движок, который мы оживляем">II</a>—<strong>III</strong>—<a href="{{ '/ru/css/' | relative_url }}" title="Движок, которому нужен CSS">IV</a>—<a href="{{ '/ru/es2015-gstreamer/' | relative_url }}" title="Движок, который обогнал Chrome">V</a>—<a href="{{ '/ru/dragonfly-shadow-dom/' | relative_url }}" title="Opera Dragonfly и Shadow DOM">VI</a>—<a href="{{ '/ru/storage/' | relative_url }}" title="Движок, который снова научился гуглить">VII</a> · <a href="{{ '/modern/' | relative_url }}" lang="en">English</a> · <strong>Русский</strong>
</nav>
