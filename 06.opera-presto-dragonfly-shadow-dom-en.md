...
- doesn't support what Presto itself can't do: flexbox, grid, Service Workers, [IndexedDB]({{ '/indexeddb-hwaccel/' | relative_url }}#xxxviii-finalizing-the-transaction), Cache Storage, Shadow DOM, custom elements.
